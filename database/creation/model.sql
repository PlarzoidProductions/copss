...
CREATE TABLE IF NOT EXISTS `iron_arena`.`achievements` (
  ...
  `tournament_id` INT(10) UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `iron_arena`.`prizes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `iron_arena`.`prizes` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `iron_arena`.`prize_redemptions` (
  ...
  CONSTRAINT `fk_prize_redemptions_player_id`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_prize_redemptions_prize_id`
    FOREIGN KEY (`id`)
    REFERENCES `iron_arena`.`prizes` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
CREATE TABLE IF NOT EXISTS `iron_arena`.`shifts` (
  ...
  `tournament_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_shifts_tournament_id_idx` (`tournament_id` ASC),
  CONSTRAINT `fk_shifts_tournament_id`
    FOREIGN KEY (`tournament_id`)
    REFERENCES `iron_arena`.`tournaments` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `iron_arena`.`shift_registrations`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `iron_arena`.`shift_registrations` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` INT UNSIGNED NOT NULL,
  `shift_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_shift_reg_user_id_idx` (`user_id` ASC),
  INDEX `fk_shift_reg_shift_id_idx` (`shift_id` ASC),
  CONSTRAINT `fk_shift_reg_user_id`
    FOREIGN KEY (`user_id`)
    REFERENCES `iron_arena`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_shift_reg_shift_id`
