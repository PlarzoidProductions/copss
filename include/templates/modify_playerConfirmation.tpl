...
<table align="center" width="78%"><tr><td align="center">
	<table align="center">
		<tr align="center"><td><h2><?php if($success) { ?>Player Successfully Updated!
						<?php } else { ?><font class="warning">Player Update Failed!</font><?php }?>
			</h2></td></tr>
		<tr><td><hr></td></tr>
	</table>
</td><tr>
<tr><td align="center">
	<table align="center" width="78%">
		...
		<tr align="center"><td colspan=2><a href="index.php?view=Add_Player"><?php if(!$success) {?>Try Again!<?php } else { ?>Update another player?<?php }?></a></td></tr>
	</table>
</td></tr>
</table>
